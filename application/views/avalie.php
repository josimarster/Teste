			...
			<div class="wrapper">
				...
				<div class="cont680 left">
					...
					<div class="contato_form">
						<form method="post" id="contato_form" name="avaliar" action="<?php echo site_url('avalie')?>">
							<select name="imovelpara">
								<option> Venda </option>
								<option> Locação </option>
							</select>
							<input name="tipoimovel" type="text" placeholder="Tipo do imovel"/>
							...
							<input name="dormitorios" type="text" placeholder="Dormitórios"/>
							<input name="garagem" type="text" placeholder="Garagem"/>
							<input name="area" type="text" placeholder="Área m²"/>
							<input name="andar" type="text" placeholder="Andar"/>
